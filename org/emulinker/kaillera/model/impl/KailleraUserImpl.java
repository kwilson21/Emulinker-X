	...
	public String toDetailedString()
       {
               ...
               localStringBuilder.append("KailleraUserImpl[id=");
               localStringBuilder.append(getID());
               localStringBuilder.append(" protocol=");
               localStringBuilder.append(getProtocol());
               localStringBuilder.append(" status=");
               localStringBuilder.append(KailleraUser.STATUS_NAMES[getStatus()]);
               localStringBuilder.append(" name=");
               localStringBuilder.append(getName());
               localStringBuilder.append(" clientType=");
               localStringBuilder.append(getClientType());
               localStringBuilder.append(" ping=");
               localStringBuilder.append(getPing());
               localStringBuilder.append(" connectionType=");
               localStringBuilder.append(KailleraUser.CONNECTION_TYPE_NAMES[getConnectionType()]);
               localStringBuilder.append(" remoteAddress=");
               localStringBuilder.append((getSocketAddress() != null) ? EmuUtil.formatSocketAddress(getSocketAddress()) : EmuUtil.formatSocketAddress(getConnectSocketAddress()));

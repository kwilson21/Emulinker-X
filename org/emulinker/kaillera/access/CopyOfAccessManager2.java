...
public class CopyOfAccessManager2 implements AccessManager, Startable, Runnable
{
	static
	{
	...
	private static Log				log						= LogFactory.getLog(CopyOfAccessManager2.class);
	...
	public CopyOfAccessManager2(ThreadPoolExecutor threadPool) throws NoSuchElementException, FileNotFoundException
	{
		this.threadPool = threadPool;

		URL url = CopyOfAccessManager2.class.getResource("/access.cfg");
		if (url == null)
